...
return insertShape(_that);case UpdateShape() when updateShape != null:
...
return insertShape(_that);case UpdateShape():
...
return insertShape(_that.index,_that.shape);case UpdateShape() when updateShape != null:
...
return insertShape(_that.index,_that.shape);case UpdateShape():
...
class UpdateShape implements ShapeCalculatorEvent {
  const UpdateShape({required this.index, required final  Map<String, String> inputs, required this.type, required this.unit}): _inputs = inputs;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UpdateShapeCopyWith<UpdateShape> get copyWith => _$UpdateShapeCopyWithImpl<UpdateShape>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateShape&&(identical(other.index, index) || other.index == index)&&const DeepCollectionEquality().equals(other._inputs, _inputs)&&(identical(other.type, type) || other.type == type)&&(identical(other.unit, unit) || other.unit == unit));
}


@override
int get hashCode => Object.hash(runtimeType,index,const DeepCollectionEquality().hash(_inputs),type,unit);

@override
String toString() {
  return 'ShapeCalculatorEvent.updateShape(index: $index, inputs: $inputs, type: $type, unit: $unit)';
}
...
/// @nodoc
abstract mixin class $UpdateShapeCopyWith<$Res> implements $ShapeCalculatorEventCopyWith<$Res> {
  factory $UpdateShapeCopyWith(UpdateShape value, $Res Function(UpdateShape) _then) = _$UpdateShapeCopyWithImpl;
@useResult
$Res call({
 int index, Map<String, String> inputs, ShapeType type, String unit
});
...
/// @nodoc
class _$UpdateShapeCopyWithImpl<$Res>
    implements $UpdateShapeCopyWith<$Res> {
  _$UpdateShapeCopyWithImpl(this._self, this._then);

  final UpdateShape _self;
  final $Res Function(UpdateShape) _then;

/// Create a copy of ShapeCalculatorEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? index = null,Object? inputs = null,Object? type = null,Object? unit = null,}) {
  return _then(UpdateShape(
index: null == index ? _self.index : index // ignore: cast_nullable_to_non_nullable
...
as ShapeType,unit: null == unit ? _self.unit : unit // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
